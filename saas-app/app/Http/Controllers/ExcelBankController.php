...
use App\Models\ExcelBank;

class ExcelBankController extends Controller
{
    ...
    {
        $documents = ExcelBank::where('domain', Auth::user()->domain)
    ...
    public function upload(Request $request)
    {
        ...
        return response()->json(['message' => 'Excel-tiedosto ladattu', 'document' => $doc], 201);
    }
    ...
    public function view(Request $request, $id)
    {
        ...
        return response($fileContent, 200)
            ...
            ->header('Content-Disposition', 'inline; filename="' . $doc->document_name . '.xlsx"')
    ...
    public function download(Request $request, $id)
    {
        ...
        return Storage::disk('local')->download($doc->document_file_path, $doc->document_name . '.xlsx');
    }
    ...
    private function getDocumentForDomain($id): ExcelBank
    {
        $doc = ExcelBank::findOrFail($id);
